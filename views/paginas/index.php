...
<section class="speakers">
  ...
  <p class="speakers__descripcion">Conoce a nuestros expertos de AstroCamp</p>
...
<section class="boletos">
  ...
  <p class="boletos__descripcion">Precios para AstroCamp</p>

  <div class="boletos__grid">
    <div <?php aos_animacion(); ?> class="boleto boleto--presencial">
      <h4 class="boleto__logo">AstroCamp</h4>
